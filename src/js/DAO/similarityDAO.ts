...
import { DataProvider, SimilarityValue } from "../types/simvizTypes";
...
export class SimilarityDAO {
   ...
   */
  init(
    similarityFunctions: Array<DataProvider> | null,
  ...
  getListSimilarityAttsByName(simFuncName: string): Array<string> | null {
    if (simFuncName in this.similarityDB) {
      return Object.keys(
        this.similarityDB[simFuncName].similarityConfiguration["localSim"]
      );
    } else return null;
  }
...
/**
 * A singleton-like instance of the SimilarityDAO
 */
